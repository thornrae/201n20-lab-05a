...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var sum2 = sum(testArray[2], sum1[0]);
  console.log(sum2[0]);
  var string = `${testArray} was passed in as an array of numbers, and ${sum2[0]} is their sum.`
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var product2 = multiply(testArray[2], product1[0]);
  // console.log(product2[0]);
  var string = `The numbers ${testArray} have a product of ${product2[0]}.`;
